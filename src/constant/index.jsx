...
export const TiengViet = "Tiếng Việt";
...
export const AUTH_CURRENT_USER_KEY = "currentUser";

export const PUBLIC_URL = `${process.env.PUBLIC_URL}`;

// export const API_HOST = "https://theediting.studio";
export const API_HOST = "http://localhost:8765";
...
export const ROWS_PER_PAGE = [20, 25, 30];
...
export const PAYMENT_METHOD_URL = {
  ...
  CREATE: "payment-methods/add",
  DELETE: "payment-methods/delete/",
  UPDATE: "payment-methods/edit/",
};

export const USER_GROUP_URL = {
  GET_ALL: "groups",
  GET: "groups/view/",
  CREATE: "groups/add",
...
export const ORDER_STATUS_DRAFT = 0; // CREATED, NOT PAYMENT
export const ORDER_STATUS_READY = 1; // Image provided, order is ready to process
export const ORDER_STATUS_PROCESSING = 2; // ASSIGNED TO DESIGNER, DESIGNER IS WORKING ON ORDER
export const ORDER_STATUS_WAITING_FEEDBACK = 3; // DESIGNER FINISH, WAITING FOR FEEDBACK
export const ORDER_STATUS_HAS_FEEDBACK = 4; // ORDER APPROVED BY STUDIO
export const ORDER_STATUS_APPROVED = 5; // ORDER APPROVED BY STUDIO
export const ORDER_STATUS_DELETED = 6; // ORDER APPROVED BY STUDIO
...
export const GOOGLE_CLIENT_ID =
  "255251039749-j218mb84sb763im33fookn1810ihlb70.apps.googleusercontent.com";
export const FACEBOOK_CLIENT_ID = "187510016564965";
