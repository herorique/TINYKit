...
export const WATCH_ADMIN_ADD = "WATCH_ADMIN_ADD";
export const WATCH_ADMIN_EDIT = "WATCH_ADMIN_EDIT";
export const WATCH_ADMIN_DELETE = "WATCH_ADMIN_DELETE";
export const WATCH_ADMIN_FETCH_ALL = "WATCH_ADMIN_FETCH_ALL";
...
export const ADMIN_RESET_EDITED = "ADMIN_RESET_EDITED";
export const ADMIN_RESET_ADDED = "ADMIN_RESET_ADDED";
export const ADMIN_RESET_DELETED = "ADMIN_RESET_DELETED";
export const UPDATE_VALUES_CHANGED = "UPDATE_VALUES_CHANGED";
