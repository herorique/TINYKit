  ...
  const onFinish = (values) => {
    ...
    axios
      ...
      .then((res) => {
        SweetAlert.fire({
          title: `Thành công`,
          text: "Bạn đã đăng ký thành công. Vui lòng kiểm tra email để tiến hành kích hoạt tài khoản",
          icon: "success",
      ...
      .catch((err) => {
        SweetAlert.fire(
          "Thất bại",
          "Đăng ký thất bại, vui lòng chọn tên đăng nhập hoặc email khác",
          "error"
        ).then((result) => {
          form.resetFields();
        });
            ...
            <Spin spinning={loading}>
              <Card>
                <CardHeader className="b-t-primary border-3">
                  ...
                  <h5 className="title f-30">{t("user.register")}</h5>
                </CardHeader>
                <CardBody>
                  <Form
                    layout="vertical"
                      ...
                      <Col span={24}>
                        <Form.Item
                          ...
                          rules={[
                            {
                              required: true,
                              message: t("user.username.error.required"),
                              whitespace: true,
                            },
                          ]}
                        >
                      ...
                      <Col span={12}>
                        <Form.Item
                          ...
                          rules={[
                            {
                              required: true,
                              message: t("user.phone.error.required"),
                            },
                          ]}
                        >
                          <Input
